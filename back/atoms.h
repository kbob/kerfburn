...
typedef enum atom {
    ...
    A_MAIN_LASER_OFF,
    A_MAIN_LASER_ON,
    A_MAIN_LASER_START_ON_MATCH,
    A_MAIN_LASER_STOP_ON_MATCH,

    A_VISIBLE_LASER_OFF,
    A_VISIBLE_LASER_ON,
    A_VISIBLE_LASER_START_ON_MATCH,
    A_VISIBLE_LASER_STOP_ON_MATCH,
#endif
#if MARTIAN
    A_MAIN_LASER_START_PULSE,
    A_MAIN_LASER_END_PULSE,
    A_MAIN_LASER_ON,
    A_MAIN_LASER_OFF,

    A_VISIBLE_LASER_START_PULSE,
    A_VISIBLE_LASER_END_PULSE,
    A_VISIBLE_LASER_ON,
    A_VISIBLE_LASER_OFF,
#endif
