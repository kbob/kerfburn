...
{
    return PIN_BIT_IS(LOW_VOLTAGE_ENABLE_PORT, LOW_VOLTAGE_ENABLED);
}

static inline bool low_voltage_is_ready(void)
{
    return PIN_BIT_IS(LOW_VOLTAGE_READY_PORT, LOW_VOLTAGE_READY);
}

static inline void enable_low_voltage(void)
{
    SET_PIN_BIT(LOW_VOLTAGE_ENABLE_PORT, LOW_VOLTAGE_ENABLED);
}

static inline void disable_low_voltage(void)
{
    SET_PIN_BIT(LOW_VOLTAGE_ENABLE_PORT, LOW_VOLTAGE_DISABLED);
}
